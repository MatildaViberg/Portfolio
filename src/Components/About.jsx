    ...
    return (
        <div name="about"
            ...
            <div className="max-w-screen-lg px-8 py-8 mx-auto flex flex-col justify-center w-full h-full">
                ...
                <p className="text-1xl text-white ">I am a UX designer based in Stockholm with a Master’s degree in User Experience and Interactive Media Design, with a particular focus on AI development and human–AI co-creation.
                    ...
                    <br>
                    </br> Through my studies and recent hands-on work, I have moved between user research, interaction design, and implementation, and I am comfortable working both conceptually and practically. I am particularly interested in how structure, systems, and constraints shape not only design decisions, but also how humans interact and co-create with intelligent systems.
